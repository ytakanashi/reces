...
●使用方法
   ...
   ・動作モードを指定します。省略すると、/mrzipとして処理します。
        ...
        /ms[library][:prefix]
          ...
          ・recesで対応していないアーカイバライブラリは[prefix]を指定することで扱うことが出来ます。
            例えば、cab32.dllを使用するには、「/mscab32.dll:Cab」とします。
        ...
        /mS<library>[:prefix]
          ...
          ・recesで対応していないアーカイバライブラリは[prefix]を指定することで扱うことが出来ます。
            例えば、unzip32.dllの設定を行うには、「/mSunzip32.dll:UnZip」とします。
 ...
 /s<value>
   ...
   ・分割サイズ指定は末尾に<b|k|m|g|t>を付加します。
     例えば、10MBで分割するには「/s10m」と指定します。
   ・末尾に<b|k|m|g|t>がなければ、分割数指定として処理します。
     例えば、12個に分割するには「/s12」と指定します。
