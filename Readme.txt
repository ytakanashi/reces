...
●説明
 「reces」は、コマンドプロンプト上で書庫の「再圧縮」「圧縮」「解凍」「内容一覧表示」「検査」「削除」を行うソフトウェアです。
...
●使用方法
 ...
 /C<CodePage|Charset>
   ・書庫ファイルの文字コードを指定します。 {mr/me/ml/mt/md}
...
●注意
 ...
 ・パスワード付7z自己解凍書庫の作成には7-zip32.dllと同じ階層に7z.sfx(7-zip公式サイトより入手可能)を用意する必要があります。
 ...
 ・元のファイルと異なるライブラリを指定することは出来ません。(/ml8-zip32.dll)
...
●ライセンス
 ...
 ・Nozomu Katô氏による「SRELL」( http://www.akenotsuki.com/misc/srell/ )は
   BSD Licenseの下で配布されています。
   ライセンスの詳細はSrc.7z/Src/third-party/SRELL/license.txtをご覧ください。
