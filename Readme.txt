...
●インストール
 1.「reces000r28.zip」を適当なディレクトリに解凍して下さい。
...
●開発環境
 ...
 debugger:Microsoft Visual C++ 2010 Express
...
●ライセンス
 ...
 ・Nozomu Katô氏による「SRELL」(http://www.akenotsuki.com/misc/srell/)は
   ...
   ライセンスの詳細はSrc.7z/Src/third-party/SRELL/license.txtをご覧下さい。
