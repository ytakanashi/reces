...
●インストール
 1.「reces000r32.zip」を適当なディレクトリに解凍してください。
...
●使用例
 ...
 例2.書庫内ファイル名の数字部分を0で埋めて2桁に揃える。
     ・「IMG_1.jpg」「IMG_2.jpg」...「IMG_10.jpg」「IMG_11.jpg」が含まれる書庫について、
       1桁の数字部分先頭に「0」を付加する。
     reces /mN_(\d\D):_0$1 arc.zip
 例3.書庫内ファイル名の数字部分を0で埋めて3桁に揃える。
     ・「IMG_1.jpg」「IMG_2.jpg」...「IMG_10.jpg」「IMG_11.jpg」...「IMG_100.jpg」...が含まれる書庫について、
       数字部分先頭に「0」を付加して3桁で揃える。
     ・今回の例では、0を一つずつ追加するので、2回リネームする必要があります。
     reces /mN(^^^|\D+)(\d{1,2}\D):$010$02 arc.zip
     reces /mN(^^^|\D+)(\d{1,2}\D):$010$02 arc.zip
       もしくは
     reces /mN(^^^|\D+)(\d{1,2}\D):$010$02;(^^^|\D+)(\d{1,2}\D):$010$02 arc.zip
       もしくは
     reces /mN arc.zip
     リネーム条件入力(正規表現):
     検索文字列: (^|\D+)(\d{1,2}\D)
...
●開発履歴
 ...
 ・7-zip32.dll/7-zip64.dll文字化け対策版 Ver.16.01.00.01 betaに更新。
